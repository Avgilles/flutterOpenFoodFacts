...
/*class AppRoutes {
  ...
  static const String fiche = '/fiche';
  static const String carateristique = '/carateristique';
  static const String nutrition = '/nutrition';
  static const String tableau = '/tableau';
  const AppRoutes._();
    ...
    switch (routeName) {
      ...
      // Sous la forme (/post?id=123)
        builder = (BuildContext context) =>
            PostsViewerScreen(route.queryParameters['id']);
        break;
    }
